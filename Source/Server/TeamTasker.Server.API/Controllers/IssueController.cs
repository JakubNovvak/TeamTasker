...
namespace TeamTasker.Server.API.Controllers
{
    ...
    public class IssueController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("GetNumberOfNewIssues", Name = "GetNumberOfNewIssues")]
        public IActionResult GetNumberOfNewIssues(int projectId)
        {
            try
            {
                var issue = _issueService.GetNumberOfNewIssues(projectId);
                return Ok(issue);
            }
            catch (KeyNotFoundException ex)
            {
        ...
        [HttpGet]
        [Route("GetNumberOfInProgressIssues", Name = "GetNumberOfInProgressIssues")]
        public IActionResult GetNumberOfInProgressIssues(int projectId)
        {
            try
            {
                var issue = _issueService.GetNumberOfInProgressIssues(projectId);
                return Ok(issue);
            }
            catch (KeyNotFoundException ex)
            {
        ...
        [HttpGet]
        [Route("GetNumberOfOnHoldIssues", Name = "GetNumberOfOnHoldIssues")]
        public IActionResult GetNumberOfOnHoldIssues(int projectId)
        {
            try
            {
                var issue = _issueService.GetNumberOfOnHoldIssues(projectId);
                return Ok(issue);
            }
            catch (KeyNotFoundException ex)
            {
